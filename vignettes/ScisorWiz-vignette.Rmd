...
# Find mismatches in gene Snap25
...
[1] "===== Finding chromosome, start, and end of gene ====="
[1] ".bam file = ~/ScisorWiz/inst/extdata/userInput/fqFolder/sorted.Snap25.bam"
[1] ".fasta file = ./mm10.fa"
[1] "Chromosome = chr2"
[1] "Gene start = 136713453"
[1] "Gene end = 136782428"
[1] "Output directory = outputDir/"
...
- outputDir/Snap25
    ...
    - Snap25.mismatches.txt.gz (The same file as the one in [`inst/extdata`](../inst/extdata), it may contain different variants from those in plots we have shown as the bam input is a subset of original files we used in analyses; one line per readID with following structure:)
